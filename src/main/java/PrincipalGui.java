    ...
    public static void main(String[] args) throws InterruptedException, ExecutionException {
        ...
        button.addActionListener(e -> {
            ...
            for (int j = 0; j < height; j++) {
                futures[j] = executorService.submit(new CalcularColores(j, j + 1, width, height, x1, y1, x2, y2));
            }
            ...
            MostrarImagen panel = new MostrarImagen(width, height, x1, y1, x2, y2, colors);
